...
class Fragmen2 : Fragment(), OnMapReadyCallback, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener {

    private lateinit var map: GoogleMap

    //se pone antes de cualquiera para usarla cuando queras lateinit
    companion object {
    ...
    override fun onCreateView(
        ...
        //val root=inflater.inflate(R.layout.fragment_fragmen2, container, false)
    ...
    private fun crearMarcador() {
        val coordenadas = LatLng(39.96858048111214,-0.5795682840921537)
